...
DepFileGenerator::DepFileGenerator(const DepFileOutputOptions &Opts)
...
void DepFileGenerator::attachToPreprocessor(Preprocessor &PP) {
...
bool DepFileGenerator::sawDependency(StringRef Filename, bool FromModule,
  ...
  if (DependencyCollector::isSpecialFilename(Filename))
    return false;
...
void DepFileGenerator::finishedMainFile(DiagnosticsEngine &Diags) {
  outputDepFile(Diags);
}
...
static void PrintFilename(raw_ostream &OS, StringRef Filename,
  ...
  if (OutputFormat == DepFileOutputFormat::NMake) {
  ...
  assert(OutputFormat == DepFileOutputFormat::Make);
...
void DepFileGenerator::outputDepFile(DiagnosticsEngine &Diags) {
...
void DepFileGenerator::outputDepFile(llvm::raw_ostream &OS) {
